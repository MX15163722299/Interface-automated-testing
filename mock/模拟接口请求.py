...
import requests
# url = "http://192.168.1.19:5000/update_user_info"
# url = "http://192.168.1.19:5000/login"
# url = "http://192.168.1.19:5000/submit_order"
#update_user_info   login
# payload = {"username": "user1", "password": "p001"}
# payload = {'username': 'user1', 'info': {'age': 25}}
# headers = {"Cookie": "uid=u001; Path=/"}
# res = requests.post(url=url, json=payload,headers=headers)
# res = requests.post(url=url5, data=payloa5)
print(res.status_code)
print(res.text)
print(f"响应时间：{(res.elapsed.total_seconds()*1000):.3f} 毫秒")